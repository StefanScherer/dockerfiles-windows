...
rebase-docker-image stefanscherer/mongo-windows:$version-1607 -t stefanscherer/mongo-windows:$version-1803 -b microsoft/nanoserver:1803
...
docker manifest create `
  ...
  stefanscherer/mongo-windows:$version-1803
