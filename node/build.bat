call :build 4.8.1 4.8 4
call :build 6.10.1 6.10 6
call :build 7.7.4 7.7 7
...
docker tag node:%1 node:%3-windowsservercore || exit /b
...
docker tag node:%1-nano node:%3-nanoserver || exit /b
