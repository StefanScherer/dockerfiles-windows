...
docker build -t node:6.9.0 6.9 || exit /b
docker tag node:6.9.0 node:latest || exit /b
docker tag node:6.9.0 node:6.9 || exit /b
docker tag node:6.9.0 node:6 || exit /b

docker build -t node:6.9.0-onbuild 6.9/onbuild
docker tag node:6.9.0-onbuild node:6.9-onbuild || exit /b
docker tag node:6.9.0-onbuild node:6-onbuild || exit /b

docker build -t node:6.9.0-nano 6.9/nano || exit /b
docker tag node:6.9.0-nano node:latest-nano || exit /b
docker tag node:6.9.0-nano node:6.9-nano || exit /b
docker tag node:6.9.0-nano node:6-nano || exit /b

docker build -t node:6.9.0-nano-onbuild 6.9/nano/onbuild || exit /b
docker tag node:6.9.0-nano-onbuild node:6.9-nano-onbuild || exit /b
docker tag node:6.9.0-nano-onbuild node:6-nano-onbuild || exit /b
