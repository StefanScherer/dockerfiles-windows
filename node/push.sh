...
docker tag node:6.9.0 stefanscherer/node-windows:6.9.0
docker tag node:6.9 stefanscherer/node-windows:6.9
docker tag node:6 stefanscherer/node-windows:6

docker tag node:6.9.0-onbuild stefanscherer/node-windows:6.9.0-onbuild
...
docker tag node:6.9.0-nano stefanscherer/node-windows:6.9.0-nano
docker tag node:6.9-nano stefanscherer/node-windows:6.9-nano
docker tag node:6-nano stefanscherer/node-windows:6-nano

docker tag node:6.9.0-nano-onbuild stefanscherer/node-windows:6.9.0-nano-onbuild
