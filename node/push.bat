...
docker tag node:6.9.0 stefanscherer/node-windows:6.9.0 || exit /b
docker tag node:6.9 stefanscherer/node-windows:6.9 || exit /b
docker tag node:6 stefanscherer/node-windows:6 || exit /b

docker tag node:6.9.0-onbuild stefanscherer/node-windows:6.9.0-onbuild || exit /b
...
docker tag node:6.9.0-nano stefanscherer/node-windows:6.9.0-nano || exit /b
...
docker tag node:6.9.0-nano-onbuild stefanscherer/node-windows:6.9.0-nano-onbuild || exit /b
...
docker push stefanscherer/node-windows:6.9.0
docker push stefanscherer/node-windows:6.9
docker push stefanscherer/node-windows:6
docker push stefanscherer/node-windows:6.9.0-onbuild
...
docker push stefanscherer/node-windows:6.9.0-nano
docker push stefanscherer/node-windows:6.9-nano
docker push stefanscherer/node-windows:6-nano
docker push stefanscherer/node-windows:6.9.0-nano-onbuild
