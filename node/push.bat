...
docker tag node:6.7.0 stefanscherer/node-windows:6.7.0 || exit /b
docker tag node:6.7 stefanscherer/node-windows:6.7 || exit /b
docker tag node:6 stefanscherer/node-windows:6 || exit /b

docker tag node:6.7.0-onbuild stefanscherer/node-windows:6.7.0-onbuild || exit /b
docker tag node:6.7-onbuild stefanscherer/node-windows:6.7-onbuild || exit /b
...
docker tag node:6.7.0-nano stefanscherer/node-windows:6.7.0-nano || exit /b
docker tag node:6.7-nano stefanscherer/node-windows:6.7-nano || exit /b
docker tag node:6-nano stefanscherer/node-windows:6-nano || exit /b

docker tag node:6.7.0-nano-onbuild stefanscherer/node-windows:6.7.0-nano-onbuild || exit /b
docker tag node:6.7-nano-onbuild stefanscherer/node-windows:6.7-nano-onbuild || exit /b
...
docker push stefanscherer/node-windows:6.7.0
docker push stefanscherer/node-windows:6.7
docker push stefanscherer/node-windows:6
docker push stefanscherer/node-windows:6.7.0-onbuild
docker push stefanscherer/node-windows:6.7-onbuild
...
docker push stefanscherer/node-windows:6.7.0-nano
docker push stefanscherer/node-windows:6.7-nano
docker push stefanscherer/node-windows:6-nano
docker push stefanscherer/node-windows:6.7.0-nano-onbuild
docker push stefanscherer/node-windows:6.7-nano-onbuild
