function pushVersion($majorMinorPatch, $majorMinor, $major) {
  ...
  rebase-docker-image stefanscherer/node-windows:$majorMinorPatch-nanoserver-2016 -s microsoft/nanoserver:sac2016 -t stefanscherer/node-windows:$majorMinorPatch-nanoserver-1809 -b stefanscherer/nanoserver:10.0.17763.1
