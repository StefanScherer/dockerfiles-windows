...
docker tag node:6.4-nano stefanscherer/node-windows:6.4-nano || exit /b
...
docker tag node:6.4-nano-onbuild stefanscherer/node-windows:6.4-nano-onbuild || exit /b
...
docker push stefanscherer/node-windows:6.4-nano
docker push stefanscherer/node-windows:4-nano
docker push stefanscherer/node-windows:6.4.0-nano-onbuild
docker push stefanscherer/node-windows:6.4-nano-onbuild
