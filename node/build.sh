...
docker build -t node:6.9.0 6.9
docker tag node:6.9.0 node:latest
docker tag node:6.9.0 node:6.9
docker tag node:6.9.0 node:6

docker build -t node:6.9.0-onbuild 6.9/onbuild
docker tag node:6.9.0-onbuild node:6.9-onbuild
docker tag node:6.9.0-onbuild node:6-onbuild

docker build -t node:6.9.0-nano 6.9/nano
docker tag node:6.9.0-nano node:latest-nano
docker tag node:6.9.0-nano node:6.9-nano
docker tag node:6.9.0-nano node:6-nano

docker build -t node:6.9.0-nano-onbuild 6.9/nano/onbuild
docker tag node:6.9.0-nano-onbuild node:6.9-nano-onbuild
docker tag node:6.9.0-nano-onbuild node:6-nano-onbuild
